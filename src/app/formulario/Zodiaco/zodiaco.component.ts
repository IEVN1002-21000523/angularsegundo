...
export default class ZodiacoComponent implements OnInit {
  ...
  imprimir():void{
    ...
    this.Unombre=`Bienvenido ${this.persona.nombre}`
    this.Uedad=`Tienes la edad de ${this.persona.edad} años`
    this.Uzodiacal=`y tu signo Zodiacal es.. ${this.persona.zodiaco}`
